...
```{r}
IrlandaNoImput$Intelligence <- pc6sc$scores[,1] # RC1 - Resultados escolares
IrlandaNoImput$Socioeconomic <- pc6sc$scores[,2] # RC3 - Estatuto socio-económico
IrlandaNoImput$SchoolSupport <- pc6sc$scores[,3] # RC2 - Apoio por parte do professor
IrlandaNoImput$Hapiness <- pc6sc$scores[,4] # RC4 - Alegria e bem-estar interior
IrlandaNoImput$CareerAwareness <- pc6sc$scores[,5] # RC5 - Nível de educação e informação sobre carreiras
IrlandaNoImput$Changes <- pc6sc$scores[,6] # RC6 - Mudanças
```
