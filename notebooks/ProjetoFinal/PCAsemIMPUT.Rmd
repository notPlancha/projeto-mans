...
barplot(colMeans(subset(IrlandaNoImput,cluster==1)[,44:48]),main= "Cluster 1 - Average score in each principal component")
barplot(colMeans(subset(IrlandaNoImput,cluster==2)[,44:48]),main= "Cluster 2 - Average score in each principal component")
barplot(colMeans(subset(IrlandaNoImput,cluster==3)[,44:48]),main= "Cluster 3 - Average score in each principal component")
barplot(colMeans(subset(IrlandaNoImput,cluster==4)[,44:48]),main= "Cluster 4 - Average score in each principal component")
