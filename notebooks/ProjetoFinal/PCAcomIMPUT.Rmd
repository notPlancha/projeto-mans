...
### RC4 - Alegria e bem-estar interior
...
### RC2 - Apoio por parte do professor
...
### RC5 - Nível de educação e informação sobre carreiras
...
IrlandaImput$SchoolSupport <- pc6sc$scores[,3] # RC2 - Apoio por parte do professor
IrlandaImput$Hapiness <- pc6sc$scores[,4] # RC4 - Alegria e bem-estar interior
IrlandaImput$CareerAwareness <- pc6sc$scores[,5] # RC5 - Nível de educação e informação sobre carreiras
IrlandaImput$Changes <- pc6sc$scores[,6] # RC6 - Mudanças
```
