...
Apagar <- c("GRADE", "JOYREADP", "PRESUPP", "PASCHPOL", "PQSCHOOL", "EMOSUPP", "CURSUPP", "INFOJOB2", "ICTOUTSIDE",
            "ICTCLASS", "COMPETE", "ATTLNACT", "PERCOMP", "DISCLIMA", "ICTSCH", "CHANGE", "SCCHANGE", 
            "LMINS", "ST061Q01NA", "ST060Q01NA", "REPEAT", "ST059Q01TA", "BFMJ2", "BMMJ1")
...
### RC2 - Alegria e bem-estar interior
...
### RC5 - Apoio por parte do professor
...
### RC6 - Nível de educação e informação sobre carreiras
...
```{r}
IrlandaImput$Intelligence <- pc6sc$scores[,1] # RC1 - Resultados escolares
IrlandaImput$Socioeconomic <- pc6sc$scores[,2] # RC3 - Estatuto socio-económico
IrlandaImput$SchoolSupport <- pc6sc$scores[,3] # RC2 - Alegria e bem-estar interior
IrlandaImput$Hapiness <- pc6sc$scores[,4] # RC1 - Apoio por parte do professor
IrlandaImput$CareerAwareness <- pc6sc$scores[,5] # RC5 - Apoio por parte do professor
IrlandaImput$ICTKnowledge <- pc6sc$scores[,6] # RC6 - Nível de educação e informação sobre carreiras
```
...
```{r}
pc_dist <- dist(IrlandaImput[, 44:49])
...
wssplot(IrlandaImput[, 44:49], nc=10)
```

```{r}
#K-means cluster com K=2
kmeans.k6 <- kmeans(IrlandaImput[, 44:49], 6, nstart=100)
...
barplot(colMeans(subset(IrlandaImput,cluster==1)[,44:49]),main= "Cluster 1 - Average score in each principal component", cex.names = 0.70)
barplot(colMeans(subset(IrlandaImput,cluster==2)[,44:49]),main= "Cluster 2 - Average score in each principal component", cex.names = 0.70)
barplot(colMeans(subset(IrlandaImput,cluster==3)[,44:49]),main= "Cluster 3 - Average score in each principal component", 
cex.names = 0.70)
barplot(colMeans(subset(IrlandaImput,cluster==4)[,44:49]),main= "Cluster 4 - Average score in each principal component", cex.names = 0.70)
barplot(colMeans(subset(IrlandaImput,cluster==5)[,44:49]),main= "Cluster 5 - Average score in each principal component", cex.names = 0.70)
barplot(colMeans(subset(IrlandaImput,cluster==6)[,44:49]),main= "Cluster 6 - Average score in each principal component", cex.names = 0.70)
```

```{r}
std_data <- scale(IrlandaImput[,44:49])
pam.k4 <- pam(std_data, 6)
```
